...
begin
  ...
  try
    ...
    QueryData.Open(Format('SELECT FIRST %d SKIP %d ID, NUMERO_ORDEM, FORNECEDOR_ID, FORNECEDOR_NOME, MARCA, REPRESENTANTE, '
    						 +'CONTATO_REPRESENTANTE, EMPRESA_NOME, EMPRESA_CNPJ, LOCAL_PEDIDO, LOCAL_ENTREGA, DATA_PEDIDO, DATA_ENTREGA, '
                 +'PRAZO_PAGAMENTO, DESCONTO_PERC, DESCONTO_VALOR, IMPOSTO_ICMS, TOTAL_PECAS, VALOR_TOTAL, STATUS, OBSERVACAO FROM PEDIDOS_COMPRA %s ORDER BY ID DESC', [LLimit, LOffset, LWhere]));
...
begin
  ...
  QueryHeader.Open(Format('SELECT ID, NUMERO_ORDEM, FORNECEDOR_ID, FORNECEDOR_NOME, MARCA, REPRESENTANTE, CONTATO_REPRESENTANTE, '
  								+ 'EMPRESA_NOME, EMPRESA_CNPJ, LOCAL_PEDIDO, LOCAL_ENTREGA, DATA_PEDIDO, DATA_ENTREGA, PRAZO_PAGAMENTO, DESCONTO_PERC, '
                  + 'DESCONTO_VALOR, IMPOSTO_ICMS, TOTAL_PECAS, VALOR_TOTAL, STATUS, OBSERVACAO FROM PEDIDOS_COMPRA WHERE ID = %d', [LId]));
...
begin
  ...
  try
    ...
    LQuery.Add('UPDATE OR INSERT INTO PEDIDOS_COMPRA (ID, NUMERO_ORDEM, FORNECEDOR_ID, FORNECEDOR_NOME, MARCA, REPRESENTANTE, '
              +'CONTATO_REPRESENTANTE, EMPRESA_NOME, EMPRESA_CNPJ, LOCAL_PEDIDO, LOCAL_ENTREGA, DATA_PEDIDO, DATA_ENTREGA, PRAZO_PAGAMENTO, DESCONTO_PERC, DESCONTO_VALOR, IMPOSTO_ICMS, TOTAL_PECAS, VALOR_TOTAL, STATUS, OBSERVACAO)');
