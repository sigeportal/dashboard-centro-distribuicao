...
type
	TFrmBuscaPedidoRemoto = class(TFrmBase)
		...
		MemPedEstPRECO_VISTA: TCurrencyField;
		MemPedEstPRECO_PRAZO: TCurrencyField;
...
begin
	...
	try
		...
		Response  := TClientRest.New(BaseURL).AddHeader('Content-Type', 'application/json').Get();
			...
			begin
				...
				begin
					...
					begin
						...
						MemPedEstPRECO_VISTA.Value := Item.PrecoVista;
						MemPedEstPRECO_PRAZO.Value := Item.PrecoPrazo;
...
procedure TFrmBuscaPedidoRemoto.EdtBuscaFornecedorKeyPress(Sender: TObject; var Key: Char);
begin
	inherited;
	BuscaPedidos;
end;
