unit UnitEtiquetaEAN13_MaxPrint;
...
type
  TFrmEtiquetaEAN13_MaxPrint = class(TForm)
    QuickRep2: TQuickRep;
    QRBand1: TQRBand;
    QRImage2: TQRImage;
    QRImage3: TQRImage;
...
var
  FrmEtiquetaEAN13_MaxPrint: TFrmEtiquetaEAN13_MaxPrint;
...
procedure TFrmEtiquetaEAN13_MaxPrint.QuickRep2BeforePrint(Sender: TCustomQuickRep; var PrintReport: Boolean);
var
  i: integer;
begin
  CDSEtiqueta.Close;
...
procedure TFrmEtiquetaEAN13_MaxPrint.QRBand1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
var
  nIdx: integer;
  BMP: TBitmap;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            Color             := clWhite;
            ColorBar          := clBlack;
            Text              := FrmEtiquetaEAN13_MaxPrint.CDSEtiquetaCODBAR.AsString;
            Ratio             := 2;
            Typ               := bcCodeEAN13;
            ShowText          := bcoBoth;
...
procedure TFrmEtiquetaEAN13_MaxPrint.FormCreate(Sender: TObject);
begin
  Images[0]   := QRImage1;
  Images[1]   := QRImage2;
  Images[2]   := QRImage3;
