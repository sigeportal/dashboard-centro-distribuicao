...
type
  ...
  private
    ...
    FEndereco: string;
    FBairro: string;
//    FCidade: string;    // Não utiliza mais
    FCep: string;
    FUf: string;
    FFone: string;
    FEmail: string;
...
//    property Cidade: string read FCidade write FCidade;
    ...
    [TCampo('CLI_COD_MUNIC', 'INTEGER')]
    property Cod_munic: integer read FCod_munic write FCod_munic;
    ...
    [TCampo('CLI_SENHA', 'VARCHAR(32)')]
    property Senha: string read FSenha write FSenha;
    [TCampo('CLI_CAMINHO_FOTO', 'VARCHAR(100)')]
    property Caminho_foto: string read FCaminho_foto write FCaminho_foto;
    [TCampo('CLI_VALIDADE_CARTAO', 'DATE')]
    property Validade_cartao: TDate read FValidade_cartao write FValidade_cartao;
    [TCampo('CLI_ESTADO', 'VARCHAR(10)')]
    property Estado: string read FEstado write FEstado;
  end;

[TNomeTabela('CLIENTES', 'CLI_CODIGO')]
  TClientesVendas = class(TTabela)
  private
    { private declarations }
    FCodigo: integer;
    FNome: string;
