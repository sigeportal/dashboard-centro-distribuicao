...
begin
	...
	Result.Cep           := Self.Cep;
	Result.Uf            := Self.Uf;
	Result.Fone          := Self.Fone;
	Result.Contato       := Self.Contato;
	Result.Email         := Self.Email;
	Result.Datac         := Self.Datac;
	Result.Datau         := Self.Datau;
	Result.Celular       := Self.Celular;
	Result.Endcorresp    := Self.Endcorresp;
	Result.Obs           := Self.Obs;
	Result.Cnpj_cpf      := Self.Cnpj_cpf;
	Result.Insc_estadual := Self.Insc_estadual;
	Result.Complemento   := Self.Complemento;
	Result.Cod_pais      := Self.Cod_pais;
	Result.Suframa       := Self.Suframa;
	Result.Indic_ie      := Self.Indic_ie;
	Result.Cid           := Self.Cid;
	Result.Razao_social  := Self.Razao_social;
	Result.Fantasia      := Self.Fantasia;
	Result.End_numero    := Self.End_numero;
	Result.Tipo          := Self.Tipo;
	Result.InscMunicipal := Self.InscMunicipal;
end;
